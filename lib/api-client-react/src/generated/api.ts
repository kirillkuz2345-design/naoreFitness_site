 ...
 */
export const submitLead = async (leadInput: LeadInput, options?: Parameters<typeof customFetch>[1]): Promise<LeadAccepted> => {

  return customFetch<LeadAccepted>(getSubmitLeadUrl(),
  {
    ...options,
    method: 'POST',
