...
function Home() {
  ...
  return <div className="site-shell noise"><a href="#main" className="skip-link">Перейти к содержанию</a><Header /><main id="main">
    <section className="hero grid-lines"><div className="container-wide hero-grid"><div><span className="eyebrow">ПЛАТФОРМА ДЛЯ РЕЗУЛЬТАТА</span><h1>Тренер и атлет.<br /><em>В одном месте.</em></h1><p className="hero-sub">Конструктор тренировок, аналитика прогресса и живое общение тренер↔клиент. Без хаоса в мессенджерах.</p><div className="actions" id="start"><a href="#for-athletes" className="btn btn-primary" data-testid="button-start-free">Начать бесплатно <ArrowRight size={16} /></a><a href="#for-trainers" className="btn btn-ghost" data-testid="button-trainer-cabinet">Я тренер — завести кабинет</a></div><div className="trust-row"><span className="trust-item"><span className="trust-dot" /> Данные под защитой (RLS)</span><span className="trust-item"><span className="trust-dot" /> Работает офлайн (PWA)</span><span className="trust-item"><span className="trust-dot" /> Русскоязычная платформа</span></div></div><ProductPreview /></div></section>
    ...
    <section className="section" id="for-trainers"><div className="container-wide"><ValuePanel role="Для тренеров" title="Тренерам: ведите клиентов профессионально и масштабируйтесь" values={trainerValues} action="Стать тренером на NAORE" /></div></section>
    <section className="section band" id="for-athletes"><div className="container-wide"><ValuePanel role="Для атлетов" title="Атлетам: понятный план, видимый прогресс, поддержка тренера" values={athleteValues} action="Начать тренироваться" reverse /></div></section>
    ...
    <section className="final-cta grid-lines" id="final-cta"><div className="container-wide"><span className="eyebrow">Следующий подход</span><h2>Готовы тренироваться и вести клиентов по-новому?</h2><div className="actions" style={{ justifyContent: 'center' }}><a href="#for-athletes" className="btn btn-primary" data-testid="button-final-start">Начать бесплатно <ArrowRight size={16} /></a><a href="#for-trainers" className="btn btn-ghost" data-testid="button-final-trainer">Стать тренером</a></div></div></section>
